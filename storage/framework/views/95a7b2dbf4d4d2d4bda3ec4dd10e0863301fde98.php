...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><?php echo e($titlePage); ?></div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('functions.store')); ?>">
                        <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aluno09\Documents\DEV\bhaskaraOficial\resources\views/functions/create.blade.php ENDPATH**/ ?>